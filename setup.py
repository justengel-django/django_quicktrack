...
if __name__ == "__main__":
    # Variables
    meta = get_meta('quicktrack/__version__.py')
    name = meta['name']
    ...
    keywords = 'Django Quick Track'
    packages = find_packages(exclude=['django_quicktrack', 'django_quicktrack/settings'])
